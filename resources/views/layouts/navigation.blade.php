@php
    $userRole = auth()->user()->roles->first()?->name ?? 'Invitado';
@endphp
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        ...
                        <x-application-logo stroke="#EF3B2D" class="block h-9 w-auto" />
                        </Link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-6 sm:flex">
                        ...
                        <div class="sm:flex sm:items-center ">
                            <x-dropdown placement="bottom-start">
                                <x-slot name="trigger">
                                    <button class="flex items-center text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out {{ request()->routeIs('dashboard.*') || request()->routeIs('users.*') ? 'text-blue-600 font-bold' : 'text-gray-500 hover:text-gray-700' }}">
                        ...
                        @endif
                        @if ($userRole === 'Secretaria' || $userRole === 'Administrador' || $userRole === 'Paciente')
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-10 ">
                        <x-dropdown placement="bottom-start">
                            <x-slot name="trigger">
                                <button class="flex items-center text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out {{ request()->routeIs('citas.*') || request()->routeIs('horarios.*') ? 'text-blue-600 font-bold' : 'text-gray-500 hover:text-gray-700' }}">
                                    <div>{{ __('Historial Medico') }}</div>
