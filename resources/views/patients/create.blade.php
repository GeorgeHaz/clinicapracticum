...
<h2 class="text-lg font-medium text-gray-900">
    ...
    <x-splade-form :action="route('patients.store')" class="mt-6 space-y-6">
        <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            <x-splade-input id="emergency_contact_phone" name="emergency_contact_phone" type="text" :label="__('Numero del contacto de emergencia')" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
        ...
        <div class="flex items-center justify-end">
            <x-splade-submit :label="__('Crear')" class="px-8"/>
        </div>
    </x-splade-form>
</x-splade-modal>