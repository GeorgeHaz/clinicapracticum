<x-splade-modal>
    ...
    <x-splade-form :action="route('users.promoteStore', $user->id)" method="POST" :default="$user">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <x-splade-input name="birthdate" date="{maxDate: 'today'}" :label="__('Fecha de Nacimiento')" required />
        ...
        <x-splade-input name="address" :label="__('Dirección')" class="pb-4" required />
