    ...
    <div class="py-3">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" flex items-center justify-end">
                <Link modal href="{{ route('appointments.create') }}" title="Agendar Cita" class="inline-flex rounded-md shadow-sm bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 mb-3 focus:outline-none focus:shadow-outline">
                    Agendar Cita
                </Link>
            </div>
